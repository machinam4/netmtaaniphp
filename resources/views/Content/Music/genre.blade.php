    ...
    <div class="container p-1">
        ...
        <div class="grid grid-cols-3 gap-4">
            @foreach ($genres as $genre)
                <a href="{{ Route('music_genre', ['genre' => $genre->genre, 'media' => $genre->media]) }}">
                    <div class="h-20 p-2 bg-clip-content bg-origin-content bg-center bg-cover rounded-md flex items-center"
