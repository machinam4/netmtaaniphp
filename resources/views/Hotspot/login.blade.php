...
<head>
    ...
    <title>NetMtaani Hotspot Login1</title>
    <link rel="stylesheet" href="{{ asset('assets/hotspot/css/bootstrap.min.css') }}">
...
<body>
    ...
    <div class="redtop pb-5" id="top"><img src="{{ asset('assets/hotspot/img/netmtaani2.jpeg') }}"
        ...
        {{-- Free content Link --}}
        <h1 class="free-content">Netmtaani Free Content,</h1>
        <div class="mx-auto">
            <a class="btn btn-danger btn-lg btn-block form-control" type="button"
                href="https://www.google.com/search?q=site%3Anetmtaani.com">
                Free Content
            </a>
        </div>

        <h1 class="free-soko mt-5">Netmtaani Free Soko,</h1>
        <div class="mx-auto">
            <a class="btn btn-warning btn-lg btn-block form-control" type="button"
                href="https://www.google.com/search?q=site%3Anetmtaani.com">Free Soko</a>
        </div>
        </h5>
            ...
            <div id="login-row" class="row justify-content-center align-items-center">
                <div id="login-column" class="col-md-6">
                    <div id="login-box" class="col-md-12">
                        ...
                        @if (session('hotspotInfo.chapid'))
                            <form name="sendin" action="{{ session('hotspotInfo.linkloginonly') }}" method="post">
                                <input type="hidden" name="username" />
                                <input type="hidden" name="password" />
                                <input type="hidden" name="dst" value="{{ session('hotspotInfo.linkorig') }}" />
...
function doLogin() {
    @if (strlen(session('hotspotInfo.chapid')) < 1)
        {{return true}}
    document.sendin.username.value = document.login.username.value;
    document.sendin.password.value = hexMD5({{session('hotspotInfo.chapid')}} + document.login.password.value +
        '{{session('hotspotInfo.chapchallenge')}}');
    ...
    return false;
                        ...
                        <form name="login" action="{{ session('hotspotInfo.linkloginonly') }}" method="post"
                            onSubmit="return doLogin()">
                            <h3 class="text-center text-info">Login to use NetMtaani service
                                {{ session('hotspotInfo.location') }}</h3>
                            @if (session('hotspotInfo.error'))
                                <br />
                                <div style="color: #FF8080; font-size: 9px">{{ session('hotspotInfo.error') }}</div>
                            @endif
                            <div class="form-group">
                                <label for="username" class="text-info">Username:</label><br>
                                <input type="text" name="username" id="username" class="form-control"
                                    value="{{ session('hotspotInfo.username') }}">
                            </div>
                            <div class="form-group">
                        ...
                        @if (session('hotspotInfo.trial') == 'yes')
                            <h1 class="free-trial">Free trial available,</h1>
                            <div class="d-grid gap-2 col-6 mx-auto">
                                <a class="btn btn-success btn-lg hidden" type="button" id="btntrial"
                                    href="page2.php?link={{ session('hotspotInfo.linkloginonly') }}&dst={{ session('hotspotInfo.linkorigesc') }}&username=T-{{ session('hotspotInfo.macesc') }}">click
                                    here</a>
                            </div>
                            </h5>
                        @endif
