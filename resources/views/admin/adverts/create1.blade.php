...
<head>
    ...
    <title>Netmtaani Dashboard</title>
                        ...
                        <div class="bg-white px-4 py-5 sm:p-6">
                            <div class="grid grid-cols-6 gap-6 text-gray-700">
                                <div class="col-span-6 sm:col-span-3">
                                    ...
                                    <p class="mt-2 text-md text-gray-500"><a href="#addSectionModal"
                                            rel="modal:open">Add
                                            New Section</a></p>
                                </div>
                                <div class="col-span-6 sm:col-span-3">
                                    ...
                                    <p class="mt-2 text-md text-gray-500"><a href="#addCategoryModal"
                                            rel="modal:open">Add
                                            New Category</a></p>
                                </div>
                                <div class="col-span-6 sm:col-span-3">
                                ...
                                <div class="col-span-6 flex justify-start mt-5">
                                    <div class="mb-3 w-96">
                                        ...
                                        <input class="filepond2" type="file" name="images" id="filepond"
                                            multiple />
                                    </div>
                                </div>
