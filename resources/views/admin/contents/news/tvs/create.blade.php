@extends('admin.base')
@section('page-title', 'Add Tv Channels')
@section('content')
        ...
        <div class="">
            <div class="">
                <div class="px-4 sm:px-0">
                    <h3 class="text-lg font-medium leading-6">Add Tv Channel</h3>
                    <p class="mt-1 text-sm">add a new Tv to the Database.</p>
                </div>
            </div>
            <div class="mt-5 ">
                <form action="{{ Route('tv_save') }}" method="POST" enctype="multipart/form-data">
                    @csrf
