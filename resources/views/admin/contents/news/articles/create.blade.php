@extends('admin.base')
@section('page-title', 'Create Scraping List')
@section('content')
        ...
        <div class="">
            <div class="">
                <div class="px-4 sm:px-0">
                    <h3 class="text-lg font-medium leading-6">Add News URL</h3>
                    <p class="mt-1 text-sm">add a new URL to the Database.</p>
                </div>
            </div>
            <div class="mt-5 ">
                <form action="{{ Route('scrape_save') }}" method="POST" enctype="multipart/form-data">
                    @csrf
