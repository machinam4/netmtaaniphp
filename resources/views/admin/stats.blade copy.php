    ...
    <div class="grid md:grid-cols-12 gap-4 sm:grid-cols-1">
        <div class="col-span-4 bg-gray-100 shadow rounded-2xl grid grid-cols-2 gap-4 p-4">
            ...
            <div class="col-span-1 bg-yellow-100 rounded-md px-2 py-5 -mt-6">
                <svg class="block text-yellow-500 w-6/12 h-3/6" xmlns="http://www.w3.org/2000/svg" fill="none"
            ...
            <div class="col-span-1 bg-blue-100 rounded-md px-2 py-5 -mt-6">
                <svg class="block text-blue-500 w-6/12 h-3/6" xmlns="http://www.w3.org/2000/svg" fill="none"
                    viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1"
                        d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z" />
                </svg>
                <h4 class="text-base font-medium text-blue-500">{{ visits('App\Models\Soko_sections')->count() }}

                </h4>
            </div>

            <div class="col-span-1 bg-red-100 rounded-md px-2 py-5">
                <svg class="block text-red-400 w-6/12 h-3/6" xmlns="http://www.w3.org/2000/svg" fill="none"
                    viewBox="0 0 128 160" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1"
            ...
            <div class="col-span-1 bg-green-100 rounded-md px-2 py-5">
                <svg class="block text-green-500 w-6/12 h-3/6" xmlns="http://www.w3.org/2000/svg" fill="none"
                    viewBox="1 -1 100 125"" stroke=" currentColor">
